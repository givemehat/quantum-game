...
class ExpectiminimaxEngine:
    ...
    def get_market_responses(self, state: np.ndarray, action: int) -> List[Tuple[np.ndarray, float]]:
        """
    ...
    def expectiminimax(self, node: GameNode, alpha: float = -math.inf, 
    ...
    def get_best_action(self, state: np.ndarray, inventory: float = 0.0) -> Tuple[int, Dict]:
        """
