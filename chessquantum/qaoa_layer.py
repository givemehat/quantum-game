...
class TradingQAOA:
    ...
    def build_cost_hamiltonian_circuit(self, gamma: float, 
                                         rewards: np.ndarray) -> QuantumCircuit:
        """
    ...
    def create_qaoa_circuit(self, gamma_params: List[float], 
    ...
    def optimize_parameters(self, rewards: np.ndarray) -> Tuple[List[float], List[float]]:
        """
    ...
    def get_action_probabilities(self, market_state: np.ndarray, 
                                  action_rewards: Dict[int, float]) -> Dict[int, float]:
        """
